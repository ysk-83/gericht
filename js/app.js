    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".body-main-slider__slider")) new core(".body-main-slider__slider", {
                ...
                pagination: {
                    el: ".body-main-slider .controll-slider",
                    clickable: true
                },
                breakpoints: {
                    320: {
                ...
                on: {
                    init: function() {
                        const controll = document.querySelectorAll(".controll-slider .swiper-pagination-bullet");
            ...
            if (document.querySelector(".slider-bar__body")) new core(".slider-bar__body", {
                modules: [ Pagination, EffectFade, Lazy, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        window.addEventListener("load", (function(e) {
            if (document.querySelector(".video-module")) document.addEventListener("watcherCallback", (function(e) {
                const entry = e.detail.entry;
                const targetElement = entry.target;
                if ("video" === targetElement.dataset.watch) if (entry.isIntersecting) {
